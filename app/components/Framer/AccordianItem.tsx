...
export default function AccordionItem({ 
  ...
  return (
    ...
    >
      ...
      {/* Main container */}
      <div className="relative backdrop-blur-xl rounded-2xl border border-border group-hover:border-primary/50 transition-all duration-300">
        {/* Question Header */}
        <motion.div
          onClick={toggleOpen}
        ...
        >
          <div className="flex items-start gap-4 flex-1">
            {/* Question number */}
            <div className="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center text-primary text-sm font-bold">
            ...
            >
              <div className="px-6 md:px-8 pb-8">
                <div className="pl-12 pr-4">
                  {/* Divider line */}
                  <div className="w-full h-px bg-gradient-to-r from-primary/50 to-transparent mb-6"></div>
