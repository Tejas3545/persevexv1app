...
const fragment = `
  ...
  void main() {
    ...
    vec3 colorDarkBlue = vec3(0.114, 0.251, 0.686); // #1d4ed8
    vec3 colorLightBlue = vec3(0.145, 0.388, 0.922); // #2563eb
    ...
    vec3 coreColor = mix(colorDarkBlue, colorLightBlue, horizontalFade);
