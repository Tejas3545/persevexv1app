...
function LogoCarousel({ partners }: { partners: typeof hiringPartners }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-white dark:bg-[#0a0a0a] border border-border shadow-sm py-6">
      {/* Fade edges */}
      <div className="absolute inset-y-0 left-0 w-24 bg-linear-to-r from-white dark:from-[#0a0a0a] to-transparent z-10 pointer-events-none" />
      <div className="absolute inset-y-0 right-0 w-24 bg-linear-to-l from-white dark:from-[#0a0a0a] to-transparent z-10 pointer-events-none" />
    ...
    <section className="section-padding bg-slate-50 dark:bg-card" id="partners">
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="text-center mb-12">
          ...
          >
            Trusted <span className="text-primary">Companies</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          {[
            ...
            <motion.div
              ...
              className="bg-white dark:bg-[#0a0a0a] shadow-sm rounded-3xl border border-border p-6 text-center hover:-translate-y-1 transition-transform duration-300"
            >
