            ...
            <div className="bg-card border border-border rounded-3xl shadow-xl p-6 md:p-8">
              ...
              <form onSubmit={handleRegister}>
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      ...
                      <div className={`text-sm ${payment === 'reserve' ? 'text-primary-foreground/90' : 'text-muted-foreground'}`}>₹{plan === 'advanced' ? '1,500' : '1,000'} now</div>
                    </div>
                    <div 
                ...
                <div className="text-center space-y-4 pt-2">
                  ...
                  >
                    {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : `Pay ${payment === 'reserve' ? `₹${plan === 'advanced' ? '1,500' : '1,000'} • Reserve seat` : `₹${plan === 'advanced' ? '4,500' : '3,500'} • Pay in full`}`}
                  </button>
