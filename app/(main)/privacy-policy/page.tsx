  ...
  return (
    <main className="relative min-h-screen w-full text-foreground bg-background overflow-x-hidden">
      ...
      <div className=" z-10 w-full max-w-6xl mx-auto px-2 md:px-6 py- sm:py-32">
        <div className="bg-transparent backdrop-blur-xs border border-border rounded-2xl p-4 md:p-12">
          
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-white to-muted bg-clip-text text-transparent">
              Privacy Policy
            </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none text-muted-foreground space-y-6 [&>h2]:pt-6 [&>h2]:text-2xl [&>h2]:font-semibold [&>h2]:text-foreground [&>h3]:pt-4 [&>h3]:text-xl [&>h3]:font-semibold [&>h3]:text-foreground">
            <p>
              Thank you for choosing to be part of our community at PERSEVEX EDUCATION CONSULTANCY LLP ("Company," "We," "Us," "Persevex," or "Our"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice or our practices with regard to your personal information, please contact us at <a href="mailto:support@persevex.com" className="text-primary hover:text-primary/80">support@persevex.com</a>.
            </p>
            <p>
              This privacy notice describes how we might use your information if you: Visit our website at <a href="https://www.persevex.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/80">https://www.persevex.com</a> or Engage with us in other related ways ― including any sales, marketing, or events.
            </p>
            ...
            <ul className="list-disc list-outside pl-6 space-y-2">
              ...
              <li><strong>To post testimonials.</strong> We post testimonials on our Website that may contain personal information. Prior to posting a testimonial, we will obtain your consent to use your name and the content of the testimonial. If you wish to update or delete your testimonial, please contact us at <a href="mailto:support@persevex.com" className="text-primary hover:text-primary/80">support@persevex.com</a> and be sure to include your name, testimonial location, and contact information.</li>
            ...
            <p>
              You may, of course, decline to submit personally identifiable information through the Website, in which case Persevex may not be able to provide certain services to you. In addition, you may update or correct your account information and email preferences at any time by logging in to your account. If you would like us to remove your personally identifiable information from our database, please send a request to <a href="mailto:support@persevex.com" className="text-primary hover:text-primary/80">support@persevex.com</a>.
            </p>
            <p>
            ...
            <p>
              If you have questions or comments about your privacy rights, you may email us at <a href="mailto:support@persevex.com" className="text-primary hover:text-primary/80">support@persevex.com</a>.
            </p>
            ...
            <p>
              To withdraw your consent, or to request the download or delete your data with us for any or all our products & services at any time, please email to <a href="mailto:support@persevex.com" className="text-primary hover:text-primary/80">support@persevex.com</a>.
            </p>

            <h2>Contact Information:</h2>
            <p>
              For any questions or concerns regarding this Privacy Policy, please contact PERSEVEX EDUCATION CONSULTANCY LLP at <a href="mailto:support@persevex.com" className="text-primary hover:text-primary/80">support@persevex.com</a>.
            </p>
