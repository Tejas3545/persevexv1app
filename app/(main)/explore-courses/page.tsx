...
export default function ExploreCoursesPage() {
  ...
  return (
    <main
      className="relative min-h-screen w-full text-foreground bg-background overflow-x-hidden scrollbar-hide"
    >
      ...
      <div className="flex flex-col items-center justify-start pt-16 min-h-screen w-full px-4 sm:px-8">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <p className="text-muted-foreground mt-2">{contentToShow.paragraph}</p>
          </motion.div>
        </AnimatePresence>

        <div className="mt-12 z-20">
          <div className="relative flex w-fit items-center rounded-full bg-background p-1 backdrop-blur-sm flex-wrap justify-center">
            <motion.div
